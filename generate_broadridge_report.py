...
html += '            <p style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.3px;color:#052390;margin:0 0 10px;">Wastage  - contractual vs. operational</p>\n'
...
html += f'                <tr><td style="border:none;padding:4px 16px 4px 0;color:#6D6E71;">(b) Operational wastage at 10%</td>'
html += f'<td style="border:none;padding:4px 0;color:#333;font-weight:600;">{fmt_num(_actual_waste_lo)} envelopes</td></tr>\n'
html += f'                <tr><td style="border:none;padding:4px 16px 4px 0;color:#6D6E71;">(c) Operational wastage at 15%</td>'
html += f'<td style="border:none;padding:4px 0;color:#333;font-weight:600;">{fmt_num(_actual_waste_hi)} envelopes</td></tr>\n'
html += f'                <tr><td style="border:none;padding:4px 16px 4px 0;color:#6D6E71;">Excess beyond contract (b)&minus;(a) to (c)&minus;(a)</td>'
